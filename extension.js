...
function activate(context) {
  ...
  subscriptions.push(
    vscode.commands.registerCommand("mocha-maty.autoPlayStart", element => {
      if (hasWorkspace()) {
  ...
  subscriptions.push(
    vscode.commands.registerCommand("mocha-maty.autoPlayPause", element => {
      if (hasWorkspace()) {
  ...
  subscriptions.push(
    vscode.commands.registerCommand("mocha-maty.runAllDebug", element => {
      if (hasWorkspace()) {
  ...
  subscriptions.push(
    vscode.commands.registerCommand("mocha-maty.debugItem", ({ item }) => {
      if (hasWorkspace()) {
  ...
  subscriptions.push(
    vscode.commands.registerCommand("mocha-maty.runAllTests", element => {
      if (hasWorkspace()) {
  ...
  subscriptions.push(
    vscode.commands.registerCommand("mocha-maty.runTest", ({ item }) => {
      if (hasWorkspace()) {
        const test = item.__test ? item.__test : item;
  ...
  subscriptions.push(
    vscode.commands.registerCommand("mocha-maty.runDescriberLevelTest", element => {
      if (hasWorkspace()) {
  ...
  subscriptions.push(
    vscode.commands.registerCommand("mocha-maty.toggleCoverage", element => {
      if (hasWorkspace()) {
        try {
  ...
  subscriptions.push(
    vscode.commands.registerCommand("mocha-maty.refreshExplorer", element => {
      if (hasWorkspace()) {
        core.run();
      }
    })
  ...
  subscriptions.push(
    vscode.commands.registerCommand("mocha-maty.coverage", element => {
      if (hasWorkspace()) {
        if (config.coverage().enable) {
  ...
  subscriptions.push(
    vscode.commands.registerCommand("mocha-maty.setSubdirectory", element => {
  ...
  subscriptions.push(
    vscode.commands.registerCommand("mocha-maty.itemSelection", item => {
      if (hasWorkspace()) {
  ...
  subscriptions.push(
    vscode.commands.registerCommand("mocha.runAllTests", function() {
      if (hasWorkspace()) {
        core.execute();
      }
    })
  ...
  subscriptions.push(
    vscode.commands.registerCommand("mocha.runTestAtCursor", function() {
      if (hasWorkspace()) {
        runTestAtCursor();
      }
    })
  ...
  subscriptions.push(
    vscode.commands.registerCommand("mocha.selectAndRunTest", function() {
      if (hasWorkspace()) {
        selectAndRunTest();
      }
    })
  ...
  subscriptions.push(
    vscode.commands.registerCommand("mocha.runFailedTests", function() {
      if (hasWorkspace()) {
        runFailedTests();
      }
    })
  ...
  subscriptions.push(
    vscode.commands.registerCommand("mocha.runTestsByPattern", function() {
      if (hasWorkspace()) {
        runTestsByPattern();
      }
    })
  ...
  subscriptions.push(
    vscode.commands.registerCommand("mocha.runLastSetAgain", function() {
      if (hasWorkspace()) {
        runLastSetAgain();
      }
    })
...
function fork(jsPath, args, options) {
  return findNodeJSPath().then(
    execPath =>
      new Promise((resolve, reject) => {
        resolve(ChildProcess.spawn(execPath, [jsPath].concat(args), options));
      }),
    err => {
