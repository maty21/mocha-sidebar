...
module.exports.redHit = () => {
    return window.createTextEditorDecorationType({
        isWholeLine: !0,
        gutterIconPath: path.join(__filename, '..', '..', 'images', 'dark', 'document', 'red-hit.svg'),
        light: {
            after: {
                color: '#fed37f',
            },
...
module.exports.yellowHit = () => {
    ...
    return window.createTextEditorDecorationType({
        isWholeLine: !0,
        gutterIconPath: path.join(__filename, '..', '..', 'images', 'dark', 'document', 'yellow-hit.svg'),
        light: {
            after: {
                color: '#fed37f',
            },
...
module.exports.greenHit = () => {
    return window.createTextEditorDecorationType({
        isWholeLine: !0,
        gutterIconPath: path.join(__filename, '..', '..', 'images', 'dark', 'document', 'green-hit.svg'),
