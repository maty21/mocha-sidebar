...
class decorationProvider {
  ...
  async init(notification) {
    this.initDecorationStyle(await core.getTests());
  ...
  initDecorationStyle(tests) {
    ...
    tests.filter(p => p.file === vscode.window.activeTextEditor.document.fileName).forEach(t => this.reloadDecorationByName(consts.NOT_RUN, t));
  }
